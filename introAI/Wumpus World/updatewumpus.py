...
# 0 Smell - clean|nasty
# 1 Air - calm|breeze
# 2 Glitter - bare|glitter
# 3 Bump - no_bump|bump
# 4 Scream - quiet|scream
# 5 Location - unique identifier for current square
# 6 Orientation - the direction you are facing
# 7 Status - living|dead|won
# 8 Score - current score
...
def build_simple_world():
    ...
    layout["Cell 31"]["Pit"]=True
    layout["Cell 33"]["Pit"]=True
    layout["Cell 44"]["Pit"]=True
    layout["Cell 13"]["Wumpus"]=True
    layout["Cell 32"]["Gold"]=True
    return layout
